...
class UserSettings extends Component {
  ...
  render() {
    ...
    return <article id="settings" className="ui segment">
        ...
        <form name="settingsAccount" onSubmit={this.submitAccount} action="/dashboard/settings/" method="POST" className="ui form">
          ...
          <button type="submit" className="ui submit button fluid" onClick={this.submitAccount}>
            Update Info
          </button>
        </form>
        ...
        <form name="socialSettings" action="/dashboard/settings/" method="POST" className="ui form">
          <section className="field">
            ...
            <section className="ui labeled input">
              <div className="ui label">twitter.com/@</div>
          ...
          <section className="field">
            ...
            <section className="ui labeled input">
              <div className="ui label">instagram.com/@</div>
          ...
          <section className="field">
            ...
            <section className="ui labeled input">
              <div className="ui label">facebook.com/</div>
            ...
            <section className="field">
              ...
              <section className="ui labeled right input">
                ...
                <div className="ui label">.tumblr.com/</div>
              </section>
            </section>
          </section>
          <section className="field">
          <button type="submit" name="submitSocial" value="submitSocial" className="ui submit button fluid" onClick={this.submitAccount}>
              Update Info
            </button>
          </section>
        </form>
